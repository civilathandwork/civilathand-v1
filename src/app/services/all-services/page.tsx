        ...
        <section className="bg-wix-dark text-white py-16 md:py-20 border-b border-white/10 relative overflow-hidden">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              ...
              <p className="mt-4 text-sm text-slate-300 leading-relaxed max-w-2xl font-medium">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="relative w-full sm:w-80">
              <input
                ...
                className="w-full bg-slate-50 border border-slate-300 rounded-xl pl-10 pr-4 py-2.5 text-xs text-slate-800 focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 font-semibold placeholder-slate-400 shadow-sm transition-all"
              />
