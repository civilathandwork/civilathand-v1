        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2.5 ml-1">
              ...
              <a href="https://linktr.ee/civilathand" target="_blank" rel="noopener noreferrer" className="hover:text-orange-500 text-slate-400 transition-colors" title="Linktree"><LinktreeIcon className="h-3.5 w-3.5" /></a>
              {/*
