...
export const GATE_QUESTIONS: Record<string, GateQuestion[]> = {
  ...
  // ─────────────────────────────────────────────
  // ─────────────────────────────────────────────
  // 1. ENGINEERING MECHANICS  (Unit-1 of the IES Master GATE PYQ book)
  //    14 real questions: Engineering Mechanics chapter (1–9)
  //    + Free Vibrations of undamped SDOF system (10–14).
  //    Answers verified against the book's ANSWER KEY. Solutions are original.
  //
  //    HOW TO USE: replace your ENTIRE  "eng-mech": [ ... ],  block
  //    (from  "eng-mech": [  up to its closing  ],  ) with this one.
  // ─────────────────────────────────────────────
  "eng-mech": [
    {
    ...
    },
    {
      ...
      // The schema stores a single index; if your runner supports multiple
      // correct answers, mark (a) and (c). Otherwise leave as-is.
      id: 2, type: "MSQ", marks: 2, neg: "0", year: "GATE-2016 SHIFT-II",
    ...
    {
      id: 3, type: "NAT", marks: 2, neg: "0", year: "GATE-2022 SHIFT-II",
    ...
    {
      id: 4, type: "MCQ", marks: 2, neg: "2/3", year: "GATE-2021 SHIFT-I",
    ...
    {
      id: 5, type: "MCQ", marks: 2, neg: "2/3", year: "GATE-2020 SHIFT-I",
    ...
    {
      id: 6, type: "MCQ", marks: 2, neg: "2/3", year: "GATE-2020 SHIFT-II",
    ...
    {
      id: 7, type: "MCQ", marks: 2, neg: "2/3", year: "GATE-2018 SHIFT-I",
    ...
    {
      id: 8, type: "MCQ", marks: 2, neg: "2/3", year: "GATE-2018 SHIFT-II",
    ...
    {
      id: 9, type: "NAT", marks: 2, neg: "0", year: "GATE-2017 SHIFT-I",
    ...
    {
      id: 10, type: "MCQ", marks: 1, neg: "1/3", year: "GATE-2019 SHIFT-I",
    ...
    {
      id: 11, type: "MCQ", marks: 2, neg: "2/3", year: "GATE-2024 SHIFT-II",
    ...
    {
      id: 12, type: "MCQ", marks: 2, neg: "2/3", year: "GATE-2022 SHIFT-II",
    ...
    {
      id: 13, type: "NAT", marks: 2, neg: "0", year: "GATE-2021 SHIFT-II",
    ...
    {
      id: 14, type: "MCQ", marks: 2, neg: "2/3", year: "GATE-2021 SHIFT-II",
      question: "A single-storey building is modelled as a rigid bar of mass m supported by three identical massless elastic columns whose ends are fixed against rotation. For each column the lateral deflection is δ = PL³/(12EI). The natural frequency of the system for horizontal oscillation is:",
      options: ["(a) (2/L)√(EI/m) rad/s", "(b) 2√(6EI/mL³) rad/s", "(c) (1/L)√(2EI/m) rad/s", "(d) 6√(EI/mL³) rad/s"],
      correct: 3,
      solution: "Each fixed-fixed column has lateral stiffness 12EI/L³. Three columns act in parallel: k = 3×12EI/L³ = 36EI/L³. ω = √(k/m) = √(36EI/mL³) = 6√(EI/mL³) rad/s."
    },
  ],
  // ─────────────────────────────────────────────
